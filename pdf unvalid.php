...
<body>
  ...
  <br><p style="color: red;"> -- Belum di Validasi --</p>
  <br><p align="right" style="color: red;"> -- Belum di Validasi --</p><br>
  Harus ditindaklanjuti maksimal tgl. :  <p style="color: red;"> -- Belum di Validasi --</p>
  </td>
  <td colspan="1">Diteruskan kepada :<br>
  <p style="color: red;"> -- Belum di Validasi --</p>
  </td>
  </tr>
...
<?php
  ...
  ?>
  <img style="width: 95%;" src="./user_data/<?php echo $tampil['FILE_NAME'];?>">
  <?php } ?>

</body>
</html>
  <?php
$filename="Disposisi".$show['no_surat'].".pdf";
$content = ob_get_clean();
  $content = '<page style="font-family: freeserif">'.nl2br($content).'</page>';
  require_once(dirname(__FILE__).'/html2pdf/html2pdf.class.php');
  try
  {
    $html2pdf = new HTML2PDF('P','A4','en', false, 'ISO-8859-15',array(7, 2, 7, 0));
