...
?>
  ...
  echo date("d/m/Y", strtotime($tanggal)); ?></td>
    ...
    <td>
        <?php if($show['valid']==1): ?>
            <p align="center"> Tervalidasi </p>

        <?php else: ?>
            <p align="center"> Belum Tervalidasi</p>
            <!--<a href="valid.php?id=<?php echo $show['id'];?>">Validasi</a>
            -->
        <?php endif; ?>
    </td>
    <td>
    <?php if($show['valid']==1): ?>
    <a href="pdf.php?id=<?php echo $show['id'];?>" class="btn btn-danger">Unduh</a>
    <?php else: ?>
        <a href="pdf unvalid.php?id=<?php echo $show['id'];?>" class="btn btn-danger">Unduh</a>
        <?php endif; ?>
    </td>
    <td>
        <?php if($show['valid']==1): ?>
            <p align="center">Terupload</p>
            <!--
            <p align="center"><button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal">Upload</button></p>
        ...
        <?php else: ?>
            <p align="center"> Belum Diupload</p>
            <!--<a href="valid.php?id=<?php echo $show['id'];?>">Validasi</a>
            -->
        <?php endif; ?>
